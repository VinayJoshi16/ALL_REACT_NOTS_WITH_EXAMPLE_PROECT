...
const Form = () => {
  ...
  return (
    <div className='h-screen lg:flex  text-white bg-[url("https://i.pinimg.com/736x/3c/0f/b0/3c0fb0256dc3e97a6f77aec6bce93da7.jpg")] bg-cover  '>
      ...
      <form onSubmit={(e) => {
        ...
        <div>
            <img
            src="https://png.pngtree.com/png-clipart/20221224/original/pngtree-man-write-in-notebook-generating-ideas-png-image_8801778.png" 
            alt="Background" 
            className="flex h-90 w-90 mt-30  " />
        </div>
